...
func (x *LoginResponse) GetTocken() string {
	if x != nil {
		return x.Tocken
	}
	return ""
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x06tocken\x18\x01 \x01(\tR\x06tocken\")\n" +
	...
	"\x06Logout\x12\x13.auth.LogoutRequest\x1a\x14.auth.LogoutResponseB\x15Z\x13shipho.sso.v1;ssov1b\x06proto3"
